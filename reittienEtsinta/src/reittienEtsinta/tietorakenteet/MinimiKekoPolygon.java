 ...
 * @author elias
 */
public class MinimiKekoPolygon {
    ...
    public MinimiKekoPolygon(double[] alkuun, double[] loppuun, int[] kekoindeksit) {
        this.keko = new int[alkuun.length + 1];
        this.keonKoko = 0;

        this.alkuun = alkuun;
        this.loppuun = loppuun;
        this.kekoindeksit = kekoindeksit;
    }
    ...
    /**
     * antaa arvion solmun,huom: ei indeksin etäisyydestä
     *
     * @param i
     * @return
     */
